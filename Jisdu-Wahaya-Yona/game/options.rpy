...
init -1 python hide:
    ...
    config.window_title = u"ᏥᏍᏚ, ᏩᏯ ᎤᏍᏗ, ᏩᏯ, ᎠᎴ ᏲᎾ ᎡᏆ"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Jisdu-Wahaya-Yona"
    config.version = "0.0"
    ...
    style.default.font = "fonts/CherokeeHandoneB.ttf"
...
python early:
    config.save_directory = "Jisdu-Wahaya-Yona-1443486677"
...
init python:
    ...
    build.directory_name = "Jisdu-Wahaya-Yona-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Jisdu-Wahaya-Yona"
